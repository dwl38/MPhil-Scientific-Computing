...
print(f'Running crystal gradual heat from {start_temp}K to {end_temp}K...')
...
for t in range(start_temp, end_temp, 1):
    ...
    ase.io.write(os.path.join(end_folder, 'final_' + str(t+1) + 'K.xyz'), atoms, append=False)
print('MD finished!')
