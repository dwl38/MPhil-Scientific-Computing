#==================================================================================================
# MD simulation at user-specified temperature (NVT ensemble) of three molecules over 1 ns (1000 ps)
#==================================================================================================
...
for i in range(20):
    ...
    ase.io.write(os.path.join(folder_prefix, 'final.xyz'), atoms, append=False)
print('MD finished!')
